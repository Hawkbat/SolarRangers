...
namespace SolarRangers.Managers
{
    public class JamScenarioManager : AbstractManager<JamScenarioManager>
    {
        ...
        void Awake()
        {
            ...
            ObjectUtils.AddReferenceFrame(rangerShip, 300f, 100f, 100000f);
        ...
        IEnumerator DoStartOuterDefensesPhase()
        {
            ...
            ObjectUtils.PlaceOnPlanet(EggTowerCombatantController.Spawn().transform, "Egg Star", new Vector3(-745f, -385f, 154f), new Vector3(55f, 44f, 131f));
            ObjectUtils.PlaceOnPlanet(EggTowerCombatantController.Spawn().transform, "Egg Star", new Vector3(-712f, -187f, -431f), new Vector3(64f, 135f, 251f));
            ObjectUtils.PlaceOnPlanet(EggTowerCombatantController.Spawn().transform, "Egg Star", new Vector3(-610f, 419f, -423f), new Vector3(62f, 205f, 331f));
            ObjectUtils.PlaceOnPlanet(EggTowerCombatantController.Spawn().transform, "Egg Star", new Vector3(-581f, 598f, 164f), new Vector3(40f, 242f, 333f));
            ObjectUtils.PlaceOnPlanet(EggTowerCombatantController.Spawn().transform, "Egg Star", new Vector3(-651f, 120f, 532f), new Vector3(71f, 351f, 39f));

            var entryDimension = SolarRangers.NewHorizons.GetPlanet("RangerEntryOuter");
            ObjectUtils.PlaceOnPlanet(AnglerCombatantController.Spawn(entryDimension.transform.Find("Sector"), 0.8f, true).transform, "RangerEntryOuter", new Vector3(0f, 0f, -200f), new Vector3(0f, 0f, 0f));
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                var radius = 828f;
                var beacon = BeaconDestructibleController.Spawn();
                beacons.Add(beacon);
                ...
                ObjectUtils.PlaceOnPlanet(beacon.transform, "Egg Star", pos, rot.eulerAngles);
            }
